...
class LongitudinalProfile(Profile):
    ...
    def __post_init__(self):
        ...
        self._w = np.arange(Config().cylinder_z_cell_no)
    ...
    def calc_first_moment(self) -> np.ndarray:
        ...
        w = [0, 1, 2, ..., Z - 1],
        alpha = Config().cylinder_z_cell_size defined in core/constants.py.
    ...
    def calc_second_moment(self) -> np.ndarray:
        ...
        where
        w = [0, 1, 2, ..., Z - 1],
        alpha = Config().cylinder_z_cell_size defined in ochre/constants.py
        ...
        return (
            np.sum(
                np.multiply(
                    np.power(
                        w * Config().cylinder_z_cell_size - first_moment, 2
                    ),
                    self._energies_per_event,
                ),
                axis=1,
            )
            / self._total_energy_per_event
...
class LateralProfile(Profile):
    ...
    def __post_init__(self):
        ...
        self._total_energy_per_event = np.sum(self._energies_per_event, axis=1)
        self._w = np.arange(Config().cylinder_rho_cell_no)
    ...
    def calc_first_moment(self) -> np.ndarray:
        ...
        w = [0, 1, 2, ..., R - 1],
        alpha = Config().cylinder_rho_cell_size defined in core/constants.py.
    ...
    def calc_second_moment(self) -> np.ndarray:
        ...
        where
        w = [0, 1, 2, ..., R - 1],
        alpha = Config().cylinder_rho_cell_size defined in ochre/constants.py
        ...
        return (
            np.sum(
                np.multiply(
                    np.power(
                        w * Config().cylinder_rho_cell_size - first_moment, 2
                    ),
                    self._energies_per_event,
                ),
                axis=1,
